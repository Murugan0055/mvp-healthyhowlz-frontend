...
const WorkoutVersionModal = ({ isOpen, onClose, versions, currentVersionId, onSelectVersion }) => {
    ...
    <div className="fixed inset-0 z-50 flex items-end justify-center sm:items-center p-0 sm:p-4">
      ...
      <div className="relative bg-white w-full max-w-md rounded-t-3xl sm:rounded-3xl shadow-2xl max-h-[80vh] flex flex-col animate-in slide-in-from-bottom-full duration-300">
        ...
        <div className="flex items-center justify-between p-5 border-b border-gray-100">
          <h3 className="text-lg font-bold text-gray-900">Workout Plan History</h3>
          <button
            onClick={onClose}
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2">
                      <h4 className={`font-bold text-sm truncate ${isSelected ? 'text-blue-900' : 'text-gray-900'}`}>
                        {version.title}
                      </h4>
                      {isCurrent && (
...
export default WorkoutVersionModal;
